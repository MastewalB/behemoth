...
// ) (*SQLite[T], error) {
// 	if userTable == "" {
// 		fmt.Println("Creating default user table")
// 		_, err := db.Exec(`
...
// 	fmt.Println("Executing query:", query, "with value:", val)
// 	row := sqlt.db.QueryRow(query, val)

// 	columns, err := getSQLiteColumnNames(sqlt.db, sqlt.userTable)
// 	if err != nil {
// 		return entity, errors.New("An error here: " + err.Error())
// 	}

// 	entity, err = mapRowToStruct(row, entity, columns)
// 	if err != nil {
// 		return entity, errors.New("Another error here: " + err.Error())
// 	}
// 	return entity, err
// }
